// AlovaChat - Professional Chat Application JavaScript

// Prevent redeclaration of AlovaChatClient class
if (typeof AlovaChatClient === 'undefined') {

    class AlovaChatClient {
        constructor() {
...
} // End of AlovaChatClient class definition guard

// Global chat client instance
let chatClient = null;

// Initialize chat client when DOM is loaded (prevent multiple initializations)
document.addEventListener('DOMContentLoaded', function () {
    if (!chatClient) {
        chatClient = new AlovaChatClient();
